...
추천 기본값은 `WATCHLIST_MIN_FACTOR_SCORE=58`, `WATCHLIST_MIN_INVESTMENT_THESIS_SCORE=55`, `WATCHLIST_MIN_DATA_QUALITY_SCORE=68`입니다. 이렇게 하면 발견 폭은 넓히되, 실전 주문은 기존보다 느슨해지지 않습니다.
